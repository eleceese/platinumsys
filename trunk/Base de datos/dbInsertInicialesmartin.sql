...
--Ciudad
insert into ciudad (CODCIUDAD, NOMBRECIUDAD) values (1, 'Luque');
...
--Producto
insert into producto (COD_PRODUCTO, DESCRIPCION, COD_MARCA, COD_PRESENTACION, COD_UNIDAD_MEDIDA, COD_TIPO_PRODUCTO, ESTADO, PRECIO_ACTUAL, COSTO_ACTUAL, CONTROLA_EXISTENCIA, CODIGO_INTERNO, FECHA_ALTA, USUARIO_ALTA, USUARIO_MODIF, FECHA_MODIF, ROWID) values (1, 'Producto Demo', 2, 0, 0, 0, 'A', 150000, 100000, 'S', '748484848', to_date('21-01-2010', 'dd-mm-yyyy'), 'ADMIN', '', null, 'AAADXXAAEAAAAOsAAA');

--Existencia
insert into existencia (COD_EXISTENCIA, COD_DEPOSITO, COD_PRODUCTO, CANTIDAD_EXISTENCIA, USUARIO_ALTA, USUARIO_MODIF, FECHA_ALTA, FECHA_MODIF) values (1, 1, 0, 2500, 'ADMIN', '', to_date('03-03-2010', 'dd-mm-yyyy'), null);
