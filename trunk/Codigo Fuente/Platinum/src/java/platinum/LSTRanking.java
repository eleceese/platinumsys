...
public class LSTRanking extends AbstractPageBean {
    ...
    public void prerender() {
        getSessionBean1().setTituloPagina("Ranking");
        getSessionBean1().setDetallePagina("Generar ranking de clientes, productos vendidos y  ranking de vendedores, en un rango de fecha inicio y fin.");
    }
