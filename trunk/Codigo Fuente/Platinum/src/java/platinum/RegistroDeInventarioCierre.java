 ...
 * @author FerBoy
 */
public class RegistroDeInventarioCierre extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        deposito1DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("1", "Deposito Central"), new com.sun.webui.jsf.model.Option("item2", "Item 2"), new com.sun.webui.jsf.model.Option("item3", "Item 3")});
        dropDown1DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("1", "Deposito Principal"), new com.sun.webui.jsf.model.Option("item2", "Item 2"), new com.sun.webui.jsf.model.Option("item3", "Item 3")});
    }
     ...
     */
    public RegistroDeInventarioCierre() {
    }
    ...
    getSessionBean1().setTituloPagina("Ajuste de Inventario");
    getSessionBean1().setDetallePagina("Seleccione el Inventario a Ajustar");
