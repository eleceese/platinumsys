 ...
 * @author FerBoy
 */
public class ABMMarcas extends AbstractPageBean {
    ...
    private StaticText datosMarca = new StaticText();

    public StaticText getDatosMarca() {
        return datosMarca;
    }

    public void setDatosMarca(StaticText st) {
        this.datosMarca = st;
    }
    ...
    getSessionBean1().setTituloPagina("Registro de Marcas");
