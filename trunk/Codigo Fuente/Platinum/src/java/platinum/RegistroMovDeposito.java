 ...
 * @author FerBoy
 */
public class RegistroMovDeposito extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        radioButtonGroup1DefaultOptions1.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("e", "Entrada"), new com.sun.webui.jsf.model.Option("s", "Salida")});
    ...
    private StaticText detalleMoviento = new StaticText();

    public StaticText getDetalleMoviento() {
        return detalleMoviento;
    }

    public void setDetalleMoviento(StaticText st) {
        this.detalleMoviento = st;
    }
    ...
    private SingleSelectOptionsList radioButtonGroup1DefaultOptions1 = new SingleSelectOptionsList();

    public SingleSelectOptionsList getRadioButtonGroup1DefaultOptions1() {
        return radioButtonGroup1DefaultOptions1;
    }

    public void setRadioButtonGroup1DefaultOptions1(SingleSelectOptionsList ssol) {
        this.radioButtonGroup1DefaultOptions1 = ssol;
    }
    ...
    private SingleSelectOptionsList deposito1DefaultOptions = new SingleSelectOptionsList();

    public SingleSelectOptionsList getDeposito1DefaultOptions() {
        return deposito1DefaultOptions;
    }

    public void setDeposito1DefaultOptions(SingleSelectOptionsList ssol) {
        this.deposito1DefaultOptions = ssol;
    }
    private SingleSelectOptionsList estado2DefaultOptions = new SingleSelectOptionsList();

    public SingleSelectOptionsList getEstado2DefaultOptions() {
        return estado2DefaultOptions;
    }
    ...
    getSessionBean1().setDetallePagina("Ingresar nuevo movimiento");
