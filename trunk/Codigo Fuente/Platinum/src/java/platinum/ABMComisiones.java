 ...
 * @author FerBoy
 */
public class ABMComisiones extends AbstractPageBean {
    ...
    private StaticText datosComision = new StaticText();

    public StaticText getDatosComision() {
        return datosComision;
    }

    public void setDatosComision(StaticText st) {
        this.datosComision = st;
    }
    ...
    getSessionBean1().setTituloPagina("Registro de % en Comisiones por ventas de Productos");
