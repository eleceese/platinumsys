...
public class LSTEstadisticaDeVenta_1 extends AbstractPageBean {
    ...
    public void setTxtAnio(TextField tf) {
        this.txtAnio = tf;
    }
     ...
     */
    public LSTEstadisticaDeVenta_1() {
    }
    ...
    public String button1_action() {
        ...
        if (txtAnio.getText() != null) {
            sql = " and to_char(c.fecha_factura, 'YYYY') = '" + txtAnio.getText().toString() + "'";
        }
        ...
        sparamValue[0] = sql;
        sparamName[1] = "logo_path";
        sparamValue[1] = theApplicationsServletContext.getRealPath("/WEB-INF/classes/reportesFuente/logo_platinum.jpg");
        sparamName[2] = "anio";
        sparamValue[2] = txtAnio.getText().toString();
