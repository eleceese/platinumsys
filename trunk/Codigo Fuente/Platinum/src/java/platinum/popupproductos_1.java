 ...
 * @author Martin Jara
 */
public class popupproductos_1 extends AbstractPageBean {
    ...
    public void setTxtBuscar(TextField tf) {
        this.txtBuscar = tf;
    }
    ...
    public void setBtnLimpiar(Button b) {
        this.btnLimpiar = b;
    }
    ...
    public String btnBuscar_action() {
        String where = " where upper(c.descripcion) like '%";
        // TODO: Replace with your code
        if (txtBuscar.getText() != null) {
            where = where + txtBuscar.getText().toString().toUpperCase() + "%'";
        } else {
            where = null;
        }
