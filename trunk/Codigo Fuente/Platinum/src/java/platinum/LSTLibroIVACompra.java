...
public class LSTLibroIVACompra extends AbstractPageBean {
    ...
    public void prerender() {
        getSessionBean1().setTituloPagina("Libro IVA Compra");
        getSessionBean1().setDetallePagina("Se ingresa los parámetros para generar el Libro IVA Compra por Tipo de Comprobante si no se ingresa un tipo de comprobante se generan el listado de todos los Comprobantes, en un rango de fecha desde – Hasta");
    }
