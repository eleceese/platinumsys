 ...
 * @author MartinJara
 */
public class ABMVentasCliente extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        dropDown2DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("P", "Pendiente"), new com.sun.webui.jsf.model.Option("E", "Entregado"), new com.sun.webui.jsf.model.Option("A", "Anulado")});
        dropDown2DefaultOptions.setSelectedValue("E");
    ...
    public void prerender() {
        ...
        if (addRequest) {
            ...
            getSessionBean1().setTituloPagina("Facturas Ventas");
    ...
    public String updateButton_action() {
        updateRequest = true;
        getSessionBean1().setTituloPagina("Editar Factura Venta");
        getSessionBean1().setDetallePagina("Registro de Facturas - Cliente");
        return null;
    }
