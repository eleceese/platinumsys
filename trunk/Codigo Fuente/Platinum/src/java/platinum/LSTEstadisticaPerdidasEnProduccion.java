...
public class LSTEstadisticaPerdidasEnProduccion extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        dropDown2DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("item1", "Administracion"), new com.sun.webui.jsf.model.Option("item2", "Elemento 2"), new com.sun.webui.jsf.model.Option("item3", "Elemento 3")});
     ...
     */
    public LSTEstadisticaPerdidasEnProduccion() {
    }
    ...
    public void prerender() {
        getSessionBean1().setTituloPagina("Listado de Estadísticas de Perdidas En Producción");
        getSessionBean1().setDetallePagina("Generar listado de estadístico de perdidas de producción por, fecha inicial, fecha final, producto genérico, tipo producto, producto, responsable, sección y numero orden de trabajo");
    }
