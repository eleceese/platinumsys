...
public class ABMPedidoCliente extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        dropDown2DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("PE", "Pendiente"), new com.sun.webui.jsf.model.Option("EN", "Entregado"), new com.sun.webui.jsf.model.Option("AN", "Anulado")});
        dropDown2DefaultOptions.setSelectedValue("EN");
    }
    ...
    public void prerender() {
        ...
        if (addRequest) {
            ...
            getSessionBean1().setTituloPagina("Pedidos Cliente");
            getSessionBean1().setDetallePagina("Registro de Pedidos Cliente");
    ...
    public String addButton_action() {
        addRequest = true;
        getSessionBean1().setTituloPagina("Nuevo Pedido Cliente");
        getSessionBean1().setDetallePagina("Registro Pedido - Cliente");
        return null;
    }
    ...
    public String updateButton_action() {
        ...
        getSessionBean1().setDetallePagina("Edición Pedido - Cliente");
        return null;
    }
