 ...
 * @author Martin Jara
 */
public class popupFormulasTerminados extends AbstractPageBean {
     ...
     */
    public popupFormulasTerminados() {
    }
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        FormulaCabecera[] l = (FormulaCabecera[]) new FormulaCabeceraController().getAllFiltered(null, param, null).toArray(new FormulaCabecera[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaFormulaCabecerasTer(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        FormulaCabecera[] l = (FormulaCabecera[]) new FormulaCabeceraController().getAllFiltered(null, null, null).toArray(new FormulaCabecera[0]);
