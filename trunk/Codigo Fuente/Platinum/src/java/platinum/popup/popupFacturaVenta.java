 ...
 * @author Martin Jara
 */
public class popupFacturaVenta extends AbstractPageBean {
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        FacturaCabecera[] l = (FacturaCabecera[]) new FacturaCabeceraController().getFacturaConSaldo(param).toArray(new FacturaCabecera[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaFacturaVenta(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        FacturaCabecera[] l = (FacturaCabecera[]) new FacturaCabeceraController().getFacturaConSaldo(null).toArray(new FacturaCabecera[0]);

        //actualizamos la lista en la session
        getSessionBean1().setListaFacturaVenta(l);
