 ...
 * @author Martin Jara
 */
public class popupDetalleOTProdDiaria extends AbstractPageBean {
     ...
     */
    public popupDetalleOTProdDiaria() {
    }
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        List<OrdenTrabajoDetalle> ordenTrabajoDetallesProdDiaria = new OrdenTrabajoDetalleController().getAllFiltered(getSessionBean1().getIdOTProdDiaria(), null,param);
        OrdenTrabajoDetalle[] detallesOT = (OrdenTrabajoDetalle[]) ordenTrabajoDetallesProdDiaria.toArray(new OrdenTrabajoDetalle[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setOrdenTrabajoDetalleArray(detallesOT);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        List<OrdenTrabajoDetalle> ordenTrabajoDetallesProdDiaria = new OrdenTrabajoDetalleController().getAllFiltered(getSessionBean1().getIdOTProdDiaria(), null,null);
        OrdenTrabajoDetalle[] detallesOT = (OrdenTrabajoDetalle[]) ordenTrabajoDetallesProdDiaria.toArray(new OrdenTrabajoDetalle[0]);
