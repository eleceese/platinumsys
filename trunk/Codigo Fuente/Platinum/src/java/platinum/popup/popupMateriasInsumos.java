...
public class popupMateriasInsumos extends AbstractPageBean {
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        Producto[] l = (Producto[]) new ProductoController().getInsumosMaterias(null, param, null).toArray(new Producto[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaInsumosMaterias(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        Producto[] l = (Producto[]) new ProductoController().getInsumosMaterias(null, null, null).toArray(new Producto[0]);
