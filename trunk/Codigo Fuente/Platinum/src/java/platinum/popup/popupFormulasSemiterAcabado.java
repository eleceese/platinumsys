 ...
 * @author Martin Jara
 */
public class popupFormulasSemiterAcabado extends AbstractPageBean {
     ...
     */
    public popupFormulasSemiterAcabado() {
    }
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        FormulaSemiCabecera[] l = (FormulaSemiCabecera[]) new FormulaSemiCabeceraController().getAllFiltered(null, param, null).toArray(new FormulaSemiCabecera[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaFormulaCabecerasSemiTer(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        FormulaSemiCabecera[] l = (FormulaSemiCabecera[]) new FormulaSemiCabeceraController().getAllFiltered(null, null, null).toArray(new FormulaSemiCabecera[0]);
