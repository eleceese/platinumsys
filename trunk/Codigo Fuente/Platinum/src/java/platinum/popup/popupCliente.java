 ...
 * @author Martin Jara
 */
public class popupCliente extends AbstractPageBean {
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        Cliente[] l = (Cliente[]) new ClienteController().getClientes(param).toArray(new Cliente[0]);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        Cliente[] l = (Cliente[]) new ClienteController().getClientes(null).toArray(new Cliente[0]);
