 ...
 * @author Martin Jara
 */
public class popupEmpleados extends AbstractPageBean {
    ...
    public String uiBtnBuscar_action() {
        //Variables
        String pNombreEmpleado = null;
        String pApellidoEmpleado = null;

        //controlamos el pNombreEmpleado
        if (uiTxtNombre.getText() != null) {
            pNombreEmpleado = uiTxtNombre.getText().toString();
        } 

        //controlamos el pApellidoEmpleado
        if (uiTxtApellido.getText() != null) {
            pApellidoEmpleado = uiTxtApellido.getText().toString();
        }

        //Obetenmos la lista
        Empleado[] l = (Empleado[]) new EmpleadoController().getEmeplados( pNombreEmpleado, pApellidoEmpleado, null).toArray(new Empleado[0]);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        Empleado[] l = (Empleado[]) new EmpleadoController().getEmeplados(null, null, null).toArray(new Empleado[0]);
