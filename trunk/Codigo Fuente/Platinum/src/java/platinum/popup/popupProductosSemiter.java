 ...
 * @author Martin Jara
 */
public class popupProductosSemiter extends AbstractPageBean {
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        Producto[] l = (Producto[]) new ProductoController().getAllFiltered(null, param, "SemiTerminado", null).toArray(new Producto[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaProductosSemiterminados(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        Producto[] l = (Producto[]) new ProductoController().getAllFiltered(null, null, "SemiTerminado", null).toArray(new Producto[0]);
