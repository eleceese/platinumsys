 ...
 * @author Martin Jara
 */
public class popupProductosTerInsMat extends AbstractPageBean {
     ...
     */
    public popupProductosTerInsMat() {
    }
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        Producto[] l = (Producto[]) new ProductoController().getInsumosMateriasFinalesSemiter(null, param,null).toArray(new Producto[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaProductosTerSemiInsMat(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        Producto[] l = (Producto[]) new ProductoController().getInsumosMateriasFinalesSemiter(null, null, null).toArray(new Producto[0]);
