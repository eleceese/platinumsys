 ...
 * @author Martin Jara
 */
public class popupProveedores extends AbstractPageBean {
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        Proveedor[] l = (Proveedor[]) new ProveedorController().getAllFiltered( param, null, null).toArray(new Proveedor[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaProveedores(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        Proveedor[] l = (Proveedor[]) new ProveedorController().getAllFiltered(null, null, null).toArray(new Proveedor[0]);
