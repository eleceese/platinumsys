 ...
 * @author Martin Jara
 */
public class popupTareaAsignadaFallos extends AbstractPageBean {
     ...
     */
    public popupTareaAsignadaFallos() {
    }
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        List<TareaAsignada> tareaAsignadasProdDiaria = new TareaAsignadaController().getAllFilteredOT(getSessionBean1().getIdOTProdDiaria().longValue(), null, param);
        ...
        //Obetenmos la lista
        List<TareaAsignada> tareaAsignadasProdDiaria = new TareaAsignadaController().getAllFilteredOT(getSessionBean1().getIdOTProdDiaria().longValue(), null, null);
        TareaAsignada[] tareaAsignadaOT = (TareaAsignada[]) tareaAsignadasProdDiaria.toArray(new TareaAsignada[0]);
