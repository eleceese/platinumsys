...
import platinum.ABMReciboDinero;
 ...
 * @author Martin Jara
 */
public class popupClientesSaldos extends AbstractPageBean {
    ...
    protected ABMReciboDinero getABMReciboDineroBean() {
        return (ABMReciboDinero) getBean("ABMReciboDinero");
    }
    ...
    public String uiBtnBuscar_action() {
        ...
        String notIN = getABMReciboDineroBean().getNotINComprobantes();

        //Obetenmos la lista
        List<VClientesSaldos> l = new SaldoClienteController().getComprobantesConSaldos(param, Long.valueOf(getABMReciboDineroBean().getUiTxtCodCliente().getText().toString()), notIN);

        //Actualizamos la lista de la session
        getABMReciboDineroBean().setLstSaldosList(l);
    ...
    public String uiBtnTodos_action() {
        //get not un comprobantes
        String notIN = getABMReciboDineroBean().getNotINComprobantes();

        //Obetenmos la lista
        List<VClientesSaldos> l = new SaldoClienteController().getComprobantesConSaldos(null, Long.valueOf(getABMReciboDineroBean().getUiTxtCodCliente().getText().toString()), notIN);
