...
public class LSTProduccion extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        uiRadioAnalisisDefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("T", "Terminado"), new com.sun.webui.jsf.model.Option("S", "SemiTerminado")});
        uiRadioAnalisisDefaultOptions.setSelectedValue("T");
    }
        ...
        // case name where null will return to the same page.
                ...
                try{
                      ...
                      if (uiFechaDesde.getSelectedDate() != null){
                        ...
                        sFecha = " and pro.fecha >= to_date('"+simpleFecha+"','dd/mm/yyyy')";
                        sF = simpleFecha;
                    }else{
                        sF="Todos";
                    }
                    ...
                    if (uiFechaHasta.getSelectedDate() != null){
                        ...
                        sFechaF = " and pro.fecha <= to_date('"+simpleFechaF+"','dd/mm/yyyy')";
                        sFF = simpleFechaF;
                    }else{
                        sFF="Todos";
                    }
               ...
               if (uiRadioAnalisis.getSelected().toString().equals("T")) {
                    rpt.getReport(conn, "ProduccionTerminados.jrxml", sparamName, sparamValue, theApplicationsServletContext);
                    }else{
                    
                    rpt.getReport(conn, "ProduccionSemiTerminado.jrxml", sparamName, sparamValue, theApplicationsServletContext);
...
//                rpt.getReport(conn, "EfectividadTareas.jrxml", sparamName, sparamValue, theApplicationsServletContext);
     ...
     * @return reference to the scoped data bean
     */
    protected ABMUnidadMedida_2 getABMUnidadMedida_2() {
        return (ABMUnidadMedida_2) getBean("ABMUnidadMedida_2");
    }
     ...
     * @return reference to the scoped data bean
     */
    protected ABMNotaCreCliente getABMNotaCreCliente() {
        return (ABMNotaCreCliente) getBean("ABMNotaCreCliente");
    }
     ...
     * @return reference to the scoped data bean
     */
    protected ABMTipoProductos_2 getABMTipoProductos_2() {
        return (ABMTipoProductos_2) getBean("ABMTipoProductos_2");
    }
     ...
     * @return reference to the scoped data bean
     */
    protected ABMUnidadMedida_3 getABMUnidadMedida_3() {
        return (ABMUnidadMedida_3) getBean("ABMUnidadMedida_3");
    }
     ...
     * @return reference to the scoped data bean
     */
    protected LoginModule getLoginModule() {
        return (LoginModule) getBean("LoginModule");
    }
     ...
     * @return reference to the scoped data bean
     */
    protected ABMNotaCreProveedor getABMNotaCreProveedor() {
        return (ABMNotaCreProveedor) getBean("ABMNotaCreProveedor");
    }
