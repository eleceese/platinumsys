...
public class LSTPedidosProvisiones extends AbstractPageBean {
    ...
    public void prerender() {
        getSessionBean1().setTituloPagina("Listado de Pedidos y Provisiones");
        getSessionBean1().setDetallePagina("Generar resumen de cantidades pedidos y proveídas por Producto si no se ingresa un producto se generan el listado de todos los productos, en un rango de fecha desde – Hasta");
    }
