 ...
 * @author FerBoy
 */
public class ABMCajas extends AbstractPageBean {
    ...
    private StaticText datosCaja = new StaticText();

    public StaticText getDatosCaja() {
        return datosCaja;
    }

    public void setDatosCaja(StaticText st) {
        this.datosCaja = st;
    }
    ...
    getSessionBean1().setTituloPagina("Registro de Cajas Cobranzas");
