...
public class LSTEfectividadPorTarea extends AbstractPageBean {
    ...
    public void prerender() {
        getSessionBean1().setTituloPagina("Efectividad en la Produccion");
        getSessionBean1().setDetallePagina("Evaluado por Tareaa.");
