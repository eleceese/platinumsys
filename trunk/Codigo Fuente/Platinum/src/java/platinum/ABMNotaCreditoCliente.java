 ...
 * @author MartinJara
 */
public class ABMNotaCreditoCliente extends AbstractPageBean {
    ...
    private TextField uiFilTxtNroNotaCredito = new TextField();

    public TextField getUiFilTxtNroNotaCredito() {
        return uiFilTxtNroNotaCredito;
    }

    public void setUiFilTxtNroNotaCredito(TextField tf) {
        this.uiFilTxtNroNotaCredito = tf;
    }
    ...
    private TextField uiTxtNroNotaCredito = new TextField();

    public TextField getUiTxtNroNotaCredito() {
        return uiTxtNroNotaCredito;
    }

    public void setUiTxtNroNotaCredito(TextField tf) {
        this.uiTxtNroNotaCredito = tf;
    }
    ...
    private Button uiBtnCargarFactura = new Button();

    public Button getUiBtnCargarFactura() {
        return uiBtnCargarFactura;
    }

    public void setUiBtnCargarFactura(Button b) {
        this.uiBtnCargarFactura = b;
    }
    ...
    public void init() {
        ...
        getSessionBean1().setTituloPagina("Nota Credito Cliente");
    ...
    public void prerender() {
        if (addRequest) {
            ...
            getSessionBean1().setTituloPagina("Nota Credito Cliente");
            getSessionBean1().setDetallePagina("Registro de Nota Credito - Cliente");
    ...
    private void limpiarCamposCabecera() {
        ...
        uiTxtNroNotaCredito.setText(null);
    ...
    public String updateButton_action() {
        ...
        updateDetRequest = true;
        itemDet = null;
        lstDetalleEliminar = new ArrayList<NotaCreditoCliDetalle>();
        ...
        if (getTableRowGroup1().getSelectedRowsCount() > 0) {
            ...
            lstDetalleLIST = cabecera.getNotaCreditoCliDetalleList();
            lstDetalle = (NotaCreditoCliDetalle[]) lstDetalleLIST.toArray(new NotaCreditoCliDetalle[0]);
            ...
            uiCalFecha.setSelectedDate(cabecera.getFechaNotaCredito());
            uiTxtSubTotal.setText(String.valueOf(cabecera.getSubTotal()));
            uiTxtTotal.setText(String.valueOf(cabecera.getTotalNotaCredito()));
    ...
    public String uiBtnGuardarNuevo_action() {
        ...
        if (!errorValidacion) {
            //Nuevo
            cabecera = new NotaCreditoCliCabecera();
            ...
            cabecera.setFechaNotaCredito(uiCalFecha.getSelectedDate());
            cabecera.setCodFactura(factura);
            ...
            if (cr.getCodRetorno() == -1) {
                ...
                uiTxtNroNotaCredito.setText(cabecera.getNumNotaCredtoCliente());
                buttonPanel.setRendered(true);
            }
    ...
    private NotaCreditoCliCabecera cabecera;
    private NotaCreditoCliCabecera[] lstCabecera;
    private NotaCreditoCliDetalle detalle;
    private NotaCreditoCliDetalle[] lstDetalle;
    private List<NotaCreditoCliDetalle> lstDetalleLIST;
    private List<NotaCreditoCliDetalle> lstDetalleEliminar;
    private Producto producto;
    private Cliente cliente;
    private TipoComprobante tipoComprobante;
    private FacturaCabecera factura = new FacturaCabecera();
    private FacturaCabeceraController facturaController = new FacturaCabeceraController();

    public NotaCreditoCliCabecera getCabecera() {
        return cabecera;
    }

    public void setCabecera(NotaCreditoCliCabecera cabecera) {
        this.cabecera = cabecera;
    }

    public NotaCreditoCliDetalle getDetalle() {
        return detalle;
    }

    public void setDetalle(NotaCreditoCliDetalle detalle) {
        this.detalle = detalle;
    }

    public NotaCreditoCliCabecera[] getLstCabecera() {
        return lstCabecera;
    }

    public void setLstCabecera(NotaCreditoCliCabecera[] lstCabecera) {
        this.lstCabecera = lstCabecera;
    }

    public NotaCreditoCliDetalle[] getLstDetalle() {
        return lstDetalle;
    }

    public void setLstDetalle(NotaCreditoCliDetalle[] lstDetalle) {
        this.lstDetalle = lstDetalle;
    }

    public List<NotaCreditoCliDetalle> getLstDetalleLIST() {
        return lstDetalleLIST;
    }

    public void setLstDetalleLIST(List<NotaCreditoCliDetalle> lstDetalleLIST) {
    ...
    public void buscar() {
        ...
        NotaCreditoClienteCabController c = new NotaCreditoClienteCabController();
        Date pFechaFactura = null;
        String pNroFactura = null, pCliente = null;

        //Nro. Pendido
        if (this.uiFilTxtNroNotaCredito.getText() != null) {
            pNroFactura = this.uiFilTxtNroNotaCredito.getText().toString();
        }
        ...
        lstCabecera = (NotaCreditoCliCabecera[]) c.getNotaCreditoCliCabecera(pNroFactura, pCliente, pFechaFactura).toArray(new NotaCreditoCliCabecera[0]);
    ...
    public String uiBtnTodos_action() {
        ...
        this.uiFilTxtNroNotaCredito.setText(null);
    ...
    public String uiBtnAgregarDet_action() {
        ...
        if (!errorValidacion) {
            ...
            if (itemDet == null) {
                detalle = new NotaCreditoCliDetalle();
            }

            //Obtenemos los datos ingresados
            detalle.setCodProducto(producto);
            detalle.setCantidad(BigInteger.valueOf(Long.valueOf(uiTxtCantidad.getText().toString())));
            detalle.setPrecioUnitario(BigInteger.valueOf(Long.valueOf(uiTxtPrecioUnitario.getText().toString())));
            detalle.setPorcentajeIva(BigInteger.valueOf(Double.valueOf(uiLstIva.getSelected().toString()).longValue()));
            detalle.setTotalIva(BigInteger.valueOf(Long.valueOf(uiTxtMontoIva.getText().toString())));
            detalle.setMonto(BigInteger.valueOf(Long.valueOf(uiTxtMontoTotal.getText().toString())));
    ...
    public String updateDetAction() {
        ...
        uiLstIva.setSelected(String.valueOf(Double.valueOf(detalle.getPorcentajeIva().toString()).longValue()));
        uiTxtMontoIva.setText(detalle.getTotalIva());
        uiTxtMontoTotal.setText(detalle.getMonto());
    ...
    private void calcularTotales() {
        ...
        for (int i = 0; i < lstDetalleLIST.size(); i++) {
            //Obetenemos el detalle
            NotaCreditoCliDetalle det = lstDetalleLIST.get(i);

            //Sumamos el monto iva
            totalIva += det.getTotalIva().longValue();
    ...
    private void cargarRelaciones() {
        ...
        getSessionBean1().cargarListaTipoComprobantePorModulo(ModuloEnum.PAGO_CLIENTE);
    ...
    public String uiBtnCargarFactura_action() {
        ...
        if (uiTxtNroFactura.getText()== null && uiTxtNroFactura.getText().toString().trim().equals("")){
            ...
            if (factura == null) {
                ...
                //Cabecera
                uiTxtCodCliente.setText(factura.getCodCliente().getCodCliente());
                uiTxtNombreCliente.setText(factura.getCodCliente().getApellidoCliente() + ", " + factura.getCodCliente().getNombreCliente());
                uiCalFecha.setSelectedDate(new Date());
                uiLstEstado.setSelected(FacturaVentaEstado.PENDIENTE_COBRO.toString());
                uiTxtTotal.setText(factura.getTotalFactura());
                uiTxtTotalIva.setText(factura.getTotalIvaFactura());
                uiTxtSubTotal.setText(factura.getSubtotalFactura());
                ...
                for (int i = 0; i < detalleFactura.size(); i++) {
                    ...
                    FacturaDetalle x = detalleFactura.get(i);

                    //Creamos el detalle de la factura
                    detalle = new NotaCreditoCliDetalle();
                    detalle.setCantidad(BigInteger.valueOf(x.getCantidad()));
                    detalle.setCodFacturaDetCliente(x);
                    detalle.setCodProducto(x.getCodProducto());
                    detalle.setFechaAlta(new Date());
                    detalle.setPorcentajeIva(BigInteger.valueOf(x.getPorcentajeIva().intValue()));
                    detalle.setPrecioUnitario(BigInteger.valueOf(x.getPrecioUnitario()));
                    detalle.setMonto(BigInteger.valueOf(x.getSubTotal()));
                    detalle.setTotalIva(BigInteger.valueOf(x.getTotalIva()));
