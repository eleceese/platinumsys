 ...
 * @author MartinJara
 */
public class ABMCalculoDeCostosFinales extends AbstractPageBean {
     ...
     */
    public ABMCalculoDeCostosFinales() {
    }
    ...
    public void init() {
        ...
        getSessionBean1().setTituloPagina("Cálculo de costos finales");
