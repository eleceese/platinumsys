                            ...
                            <h:panelGrid binding="#{ABMReciboDinero.mainContainer}" id="mainContainer"
                                ...
                                <h:panelGrid binding="#{ABMReciboDinero.addUpdatePanel}" columns="1"
                                    ...
                                    <h:panelGrid id="gridPanelFormaCobro" style="width: 100%; height: 100%;">
                                        ...
                                        <h:panelGrid columns="11" id="gridPanelDetLin1FC" style="height: 72px" width="887">
                                            ...
                                            <webuijsf:label id="lblSerieCheque" text="Serie"/>
                                            ...
                                            <webuijsf:label id="lblNroCheque" text="Nro. Documento"/>
                                            <webuijsf:textField binding="#{ABMReciboDinero.uiTxtNroFormaCobro}" columns="17" id="uiTxtNroFormaCobro"
                                                                onFocus="tieneBanco()" style="text-align: right"/>
                                            <webuijsf:label id="lblMontoTotalFC" text="Monto Cobro"/>
                                            <webuijsf:textField binding="#{ABMReciboDinero.uiTxtMontoFormaCobro}" columns="15"
                                                                converter="#{ABMReciboDinero.numberConverter1}" id="uiTxtMontoFormaCobro" style="text-align: right"/>
                                        ...
                                        <h:panelGrid columns="2" id="gridPanelTotalFormaCobro" style="margin-left: 605px" width="191">
                                            ...
                                            <webuijsf:textField binding="#{ABMReciboDinero.uiTxtTotalComprobantesFC}" columns="20" id="uiTxtTotalComprobantesFC"
