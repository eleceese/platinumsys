                    ...
                    <webuijsf:form id="form1">
                        ...
                        <div style="left: 288px; top: 216px; position: absolute">
                            <h:panelGrid columns="2" id="gridPanel1" style="height: 191px" width="407">
                                ...
                                <webuijsf:dropDown binding="#{LSTResumenTareasFallidasEmpleado.uiNroOt}" id="uiNroOt" items="#{LSTResumenTareasFallidasEmpleado.listaOtCabOp}"/>
                                <webuijsf:label id="label2" text="Empleado"/>
                                <webuijsf:dropDown binding="#{LSTResumenTareasFallidasEmpleado.uiEmpleado}" id="uiEmpleado" items="#{LSTResumenTareasFallidasEmpleado.listaEmpleadosOp}"/>
                                <webuijsf:label id="label3" text="Tarea"/>
                                <webuijsf:dropDown binding="#{LSTResumenTareasFallidasEmpleado.uiTarea}" id="uiTarea" items="#{LSTResumenTareasFallidasEmpleado.listaTareasOp}"/>
                                ...
                                <h:panelGrid id="gridPanel2" style="height: 100%" width="191">
                                    ...
                                    <webuijsf:calendar binding="#{LSTResumenTareasFallidasEmpleado.uiFechaDesde}" id="uiFechaDesde"/>
                                </h:panelGrid>
                                <h:panelGrid id="gridPanel3" style="height: 100%" width="159">
                                    <webuijsf:label id="label4" text="Hasta"/>
                                    <webuijsf:calendar binding="#{LSTResumenTareasFallidasEmpleado.uiFechaHasta}" id="uiFechaHasta"/>
                                </h:panelGrid>
                                <h:panelGrid columns="2" id="gridPanel5" style="height: 35px" width="191">
                                    <webuijsf:button actionExpression="#{LSTResumenTareasFallidasEmpleado.uiButtonEjecutar_action}" id="uiButtonEjecutar" text="Ejecutar"/>
