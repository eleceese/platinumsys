                    ...
                    <webuijsf:form id="form1">
                        ...
                        <div>
                            <h:panelGrid columns="2" id="mainContainer" style="height: 269px; left: 288px; top: 235px; position: absolute" width="456">
                                ...
                                <webuijsf:dropDown id="dropDown1" items="#{LSTEstadisticaPerdidasEnProduccion.dropDown1DefaultOptions.options}"
                                    selected="#{LSTEstadisticaPerdidasEnProduccion.dropDown1DefaultOptions.selectedValue}" style="margin-left: 11px" width="120px"/>
                                ...
                                <webuijsf:hyperlink id="linkResponsable" text="Responsable"/>
                                ...
                                <webuijsf:label id="label1" text="Sección"/>
                                <webuijsf:dropDown id="dropDown2" items="#{LSTEstadisticaPerdidasEnProduccion.dropDown2DefaultOptions.options}"
                                    selected="#{LSTEstadisticaPerdidasEnProduccion.dropDown2DefaultOptions.selectedValue}" style="margin-left: 11px" width="120px"/>
                                ...
                                <webuijsf:button actionExpression="#{LSTEstadisticaPerdidasEnProduccion.button1_action}" id="button1" text="Ejecutar"/>
                                <webuijsf:button actionExpression="#{LSTEstadisticaPerdidasEnProduccion.button2_action}" id="button2" text="Cancelar"/>
                            </h:panelGrid>
                        </div>
                    </webuijsf:form>
                </webuijsf:body>
