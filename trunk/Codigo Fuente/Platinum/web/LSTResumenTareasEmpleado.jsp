                    ...
                    <webuijsf:form id="form1">
                        ...
                        <div style="left: 288px; top: 216px; position: absolute">
                            <h:panelGrid columns="2" id="gridPanel1" style="height: 191px" width="407">
                                ...
                                <webuijsf:dropDown binding="#{LSTResumenTareasEmpleado.uiNroOt}" id="uiNroOt" items="#{LSTResumenTareasEmpleado.listaOtCabOp}"/>
                                <webuijsf:label id="label2" text="Empleado"/>
                                <webuijsf:dropDown binding="#{LSTResumenTareasEmpleado.uiEmpleado}" id="uiEmpleado" items="#{LSTResumenTareasEmpleado.listaEmpleadosOp}"/>
                                <webuijsf:label id="label3" text="Tarea"/>
                                <webuijsf:dropDown binding="#{LSTResumenTareasEmpleado.uiTarea}" id="uiTarea" items="#{LSTResumenTareasEmpleado.listaTareasOp}"/>
                                ...
                                <h:panelGrid id="gridPanel2" style="height: 100%" width="191">
                                    ...
                                    <webuijsf:calendar binding="#{LSTResumenTareasEmpleado.uiFechaDesde}" id="uiFechaDesde"/>
                                </h:panelGrid>
                                <h:panelGrid id="gridPanel3" style="height: 100%" width="159">
                                    <webuijsf:label id="label4" text="Hasta"/>
                                    <webuijsf:calendar binding="#{LSTResumenTareasEmpleado.uiFechaHasta}" id="uiFechaHasta"/>
                                </h:panelGrid>
                                <h:panelGrid columns="2" id="gridPanel5" style="height: 35px" width="191">
                                    <webuijsf:button actionExpression="#{LSTResumenTareasEmpleado.uiButtonEjecutar_action}" id="uiButtonEjecutar" text="Ejecutar"/>
