                    ...
                    <webuijsf:form id="form1">
                        ...
                        <div>
                            <h:panelGrid columns="2" id="mainContainer" style="height: 269px; left: 288px; top: 235px; position: absolute" width="456">
                                ...
                                <webuijsf:dropDown id="dropDown1" items="#{LSTEstadisticaDeOrdenTrabajo.dropDown1DefaultOptions.options}"
                                    selected="#{LSTEstadisticaDeOrdenTrabajo.dropDown1DefaultOptions.selectedValue}" style="margin-left: 11px" width="120px"/>
                                ...
                                <webuijsf:dropDown id="dropDown2" items="#{LSTEstadisticaDeOrdenTrabajo.dropDown2DefaultOptions.options}"
                                    selected="#{LSTEstadisticaDeOrdenTrabajo.dropDown2DefaultOptions.selectedValue}" style="margin-left: 11px" width="120px"/>
                                <webuijsf:button actionExpression="#{LSTEstadisticaDeOrdenTrabajo.button1_action}" id="button1" text="Ejecutar"/>
                                <webuijsf:button actionExpression="#{LSTEstadisticaDeOrdenTrabajo.button2_action}" id="button2" text="Cancelar"/>
                            </h:panelGrid>
                        </div>
                    </webuijsf:form>
                </webuijsf:body>
