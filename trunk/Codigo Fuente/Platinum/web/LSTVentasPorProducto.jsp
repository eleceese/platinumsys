                    ...
                    <webuijsf:form id="form1">
                        ...
                        <div>
                            <h:panelGrid columns="2" id="mainContainer" style="height: 269px; left: 288px; top: 235px; position: absolute; text-align: left" width="456">
                                ...
                                <webuijsf:calendar binding="#{LSTVentasPorProducto.uiCalDesde}" columns="15" id="txtFecApertura"/>
                                <webuijsf:label id="lblFecFin" text="Fecha Hasta"/>
                                <webuijsf:calendar binding="#{LSTVentasPorProducto.uiCalHasta}" columns="15" id="uiCalHasta"/>
                                <webuijsf:button actionExpression="#{LSTVentasPorProducto.button1_action}" id="button1" text="Ejecutar"/>
                                <webuijsf:button actionExpression="#{LSTVentasPorProducto.button2_action}" id="button2" text="Cancelar"/>
                            </h:panelGrid>
                        </div>
                    </webuijsf:form>
                </webuijsf:body>
