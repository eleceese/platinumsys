                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <h:panelGrid id="mainContainer" style="height: 408px; left: 240px; top: 240px; position: absolute" width="888">
                            <webuijsf:pageAlert binding="#{RegistroProDiaria_1.pageAlert1}" id="pageAlert1" rendered="false"/>
                            <h:panelGrid binding="#{RegistroProDiaria_1.gridPanelBusqueda}" id="gridPanelBusqueda" style="width: 100%; height: 100%;">
                                <h:panelGrid columns="4" id="gridPanelFiltro" style="height: 100%" width="695">
                                    <webuijsf:label id="label1" text="Responsable"/>
                                    <h:panelGrid columns="2" id="gridPanel2" style="width: 100%; height: 100%;">
                                        <webuijsf:dropDown id="uiEmpleadosFil" items="#{SessionBean1.listaEmpleadosOp}" required="true" separators="false" width="250"/>
                                    </h:panelGrid>
                                    <webuijsf:label id="label2" text="Nro OT"/>
                                    <webuijsf:textField id="uiCodOTFil"/>
                                    ...
                                    <webuijsf:button actionExpression="#{RegistroProDiaria_1.button1_action}" id="button1" text="Buscar"/>
                                    <webuijsf:dropDown id="dropDown1" items="#{RegistroProDiaria_1.dropDown1DefaultOptions.options}"/>
                                </h:panelGrid>
                                <h:panelGrid id="gridPanelTabla" style="width: 100%; height: 100%;">
                                    <webuijsf:table augmentTitle="false" id="tableTareas" title="Lista de Tareas" width="647">
                                        <webuijsf:tableRowGroup id="tableRowGroup2" rows="10" sourceData="#{RegistroProDiaria_1.defaultTableDataProvider}" sourceVar="currentRow">
                                ...
                                <h:panelGrid columns="3" id="gridPanelBotones">
                                    <webuijsf:button actionExpression="#{RegistroProDiaria_1.buttonNuevo_action}" id="buttonNuevo" text="Nuevo"/>
                                    <webuijsf:button actionExpression="#{RegistroProDiaria_1.buttonEditar_action}" id="buttonEditar" text="Editar"/>
                                    <webuijsf:button id="buttonEliminar" text="Eliminar"/>
                                </h:panelGrid>
                            </h:panelGrid>
                            <br/>
                            <h:panelGrid binding="#{RegistroProDiaria_1.gridPanelCabecera}" columns="1" id="gridPanelCabecera" style="height: 72px" width="599">
                                ...
                                <h:panelGrid columns="2" id="gridPanelOT" style="border-width: 2px; border-style: outset; height: 100%; width: 100%">
                                    ...
                                    <webuijsf:textField binding="#{RegistroProDiaria_1.uiOTNro}" id="uiOTNro"
                                        onBlur="DynaFaces.Tx.fire(&quot;actSemi&quot;, &quot;uiOTNro&quot;)" validatorExpression="#{RegistroProDiaria_1.uiOTNro_validate}"/>
                                    <webuijsf:label id="labelDesc" text="Descripcion"/>
                                    <webuijsf:textArea columns="60" id="uiDescripcion" rows="5"/>
                                    <webuijsf:hyperlink id="hyperlink1" onClick="doPopup('form1:uiSemiCod_field', 'form1:uiSemiDesc_field')" target="popup"
                                        text="SemiTerminado" url="/faces/popup/popupDetalleOTProdDiaria.jsp"/>
                                    <h:panelGrid columns="2" id="gridPanelSemi" style="margin-left: -3px">
                                        <webuijsf:textField columns="10" id="uiSemiCod"/>
                                        <webuijsf:textField columns="50" disabled="true" id="uiSemiDesc"/>
                                    </h:panelGrid>
                                </h:panelGrid>
                                <br/>
                                <h:panelGrid binding="#{RegistroProDiaria_1.buttonsPanelAddUpdate}" columns="2" id="buttonsPanelAddUpdate" style="height: 24px" width="191">
                                    <webuijsf:button actionExpression="#{RegistroProDiaria_1.cancelar_action}" id="cancelar"
                                        style="font-size: 14px; height: 24px" text="Cancelar"/>
                                    <webuijsf:button actionExpression="#{RegistroProDiaria_1.button2_action}" binding="#{RegistroProDiaria_1.button2}"
                                        id="button2" style="font-size: 14px; height: 24px" text="Guardar"/>
                                </h:panelGrid>
                            </h:panelGrid>
                            <h:panelGrid binding="#{RegistroProDiaria_1.gridPannelDetalle}" id="gridPannelDetalle" style="width: 100%; height: 100%;">
                                <webuijsf:staticText binding="#{RegistroProDiaria_1.detalleProduccion}" id="detalleProduccion"
                                ...
                                <webuijsf:tabSet id="tabSet1" lite="true" mini="true" selected="tab1" style="width: 743px">
                                    <webuijsf:tab id="tab1" text="Agregar">
                                        <webuijsf:panelLayout id="layoutPanel1" style="height: 38px; position: relative; width: 733px; -rave-layout: grid">
                                            <h:panelGrid binding="#{RegistroProDiaria_1.gridPanelAddUpdate}" columns="7" id="gridPanelAddUpdate"
                                                style="height: 48px" width="719">
                                                <webuijsf:hyperlink actionExpression="#{RegistroProDiaria_1.tarea_action}" id="tarea"
                                                    onClick="doPopup('form1:tabSet1:tab1:layoutPanel1:uiTarCod_field', 'form1:tabSet1:tab1:layoutPanel1:uiTarDet_field')"
                                                    target="popup" text="Tarea" url="/faces/popup/popupTareaAsignadaOTProdDiaria.jsp"/>
                                                <h:panelGrid columns="2" id="gridPanel3">
                                                    <webuijsf:textField binding="#{RegistroProDiaria_1.uiTarCod}" columns="8" id="uiTarCod"/>
                                                    <webuijsf:textField binding="#{RegistroProDiaria_1.uiTarDesc}" columns="50" disabled="true" id="uiTarDesc"/>
                                                </h:panelGrid>
                                                <webuijsf:label id="cantidad" text="Cantidad"/>
                                                <webuijsf:textField binding="#{RegistroProDiaria_1.uiTarCant}" columns="10" id="uiTarCant"/>
                                                <webuijsf:label id="tiempoInv" text="Tiempo(min)"/>
                                                <webuijsf:textField binding="#{RegistroProDiaria_1.uiTarTiempo}" columns="5" id="uiTarTiempo"/>
                                ...
                                <h:panelGrid id="gridPanel1" style="height: 100%; width: 100%">
                                    <webuijsf:table augmentTitle="false" id="tablaTareas" paginateButton="true" paginationControls="true"
                                        ...
                                        <webuijsf:tableRowGroup id="tableRowGroup1" rows="10" sourceData="#{RegistroProDiaria_1.defaultTableDataProvider}" sourceVar="currentRow">
