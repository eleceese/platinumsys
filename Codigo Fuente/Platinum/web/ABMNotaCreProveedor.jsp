            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <div>
                            <h:panelGrid binding="#{ABMNotaCreProveedor.mainContainer}" id="mainContainer" style="height: 96px; left: 288px; top: 216px; position: absolute; width: 96px">
                                <h:panelGrid binding="#{ABMNotaCreProveedor.gridPanelBuscar}" columns="3" id="gridPanelBuscar">
                                    ...
                                    <h:panelGrid columns="2" id="gridPanelProveedor1">
                                        ...
                                        <webuijsf:textField binding="#{ABMNotaCreProveedor.userNameFiltro}" columns="30" id="txtProveedor"/>
                                    </h:panelGrid>
                                    ...
                                    <h:panelGrid columns="2" id="gridPanelEmailFiltro">
                                        ...
                                        <webuijsf:textField binding="#{ABMNotaCreProveedor.emailAddressFiltro}" columns="30" id="emailAddressFiltro"/>
                                    </h:panelGrid>
                                    <h:panelGrid columns="2" id="panelButtonBuscar">
                                        <webuijsf:button binding="#{ABMNotaCreProveedor.buscarButton}" id="buscarButton" text="Buscar"/>
                                        <webuijsf:button binding="#{ABMNotaCreProveedor.todosButton}" id="todosButton" text="Todos"/>
                                    </h:panelGrid>
                                </h:panelGrid>
                                <webuijsf:pageAlert binding="#{ABMNotaCreProveedor.pageAlert1}" rendered="false" style="height: 72px"/>
                                <script>
                                    function ABMNotaCreditoCliente() {
                                        var table = document.getElementById("form1:table1");
                                        table.ABMNotaCreditoCliente();
                                    }
                                </script>
                                <webuijsf:table augmentTitle="false" binding="#{ABMNotaCreProveedor.table1}" clearSortButton="true" id="table1"
                                    paginateButton="true" paginationControls="true" sortPanelToggleButton="true" title="Notas de Crédito Proveedor" width="671">
                                    <webuijsf:tableRowGroup binding="#{ABMNotaCreProveedor.tableRowGroup1}" emptyDataMsg="No se recupero ningun registro..."
                                        id="tableRowGroup1" rows="10" selected="#{ABMNotaCreProveedor.selectedState}"
                                        sourceData="#{ABMNotaCreProveedor.defaultTableDataProvider}" sourceVar="currentRow">
                                ...
                                <h:panelGrid binding="#{ABMNotaCreProveedor.buttonPanel}" columns="3" id="buttonPanel">
                                    <webuijsf:button actionExpression="#{ABMNotaCreProveedor.addButton_action}" binding="#{ABMNotaCreProveedor.addButton}"
                                        id="addButton" text="Nuevo"/>
                                    <webuijsf:button actionExpression="#{ABMNotaCreProveedor.updateButton_action}" binding="#{ABMNotaCreProveedor.updateButton}"
                                        id="updateButton" text="Editar"/>
                                    <webuijsf:button actionExpression="#{ABMNotaCreProveedor.deleteButton_action}" binding="#{ABMNotaCreProveedor.deleteButton}"
                                        id="deleteButton" text="Eliminar"/>
                                </h:panelGrid>
                                <h:panelGrid binding="#{ABMNotaCreProveedor.addUpdatePanel}" columns="1" id="addUpdatePanel">
                                    <h:panelGrid columns="3" id="panelGridCabeceraCompra" style="height: 96px; text-align: left">
                                        ...
                                        <h:panelGrid columns="2" id="panelGridCabCompra2" style="text-align: right" width="205">
                                            ...
                                            <webuijsf:dropDown id="dropDown2" items="#{ABMNotaCreProveedor.dropDown2DefaultOptions.options}"
                                                selected="#{ABMNotaCreProveedor.dropDown2DefaultOptions.selectedValue}" width="126px"/>
                                        </h:panelGrid>
                                        ...
                                        <h:panelGrid columns="2" id="gridPanelProveedor" width="335">
                                            ...
                                            <webuijsf:textField binding="#{ABMNotaCreProveedor.userNameField}" columns="50" id="userNameField" valueChangeListenerExpression="#{ABMNotaCreProveedor.userNameField_processValueChange}"/>
                                        </h:panelGrid>
                                    ...
                                    <h:panelGrid columns="2" id="gridPanel1"
                                        style="direction: rtl; height: 48px; line-height: normal; margin-left: 525px; text-align: right; vertical-align: middle" width="182">
                                        <webuijsf:button actionExpression="#{ABMNotaCreProveedor.cancelButton_action}"
                                            binding="#{ABMNotaCreProveedor.cancelButton}" id="cancelButton" style="font-size: 14px" text="Cancelar"/>
                                        <webuijsf:button actionExpression="#{ABMNotaCreProveedor.addRecordButton_action}"
                                            binding="#{ABMNotaCreProveedor.addRecordButton}" id="addRecordButton" style="font-size: 14px" text="Guardar"/>
                                        <webuijsf:button actionExpression="#{ABMNotaCreProveedor.updateRecordButton_action}"
                                            binding="#{ABMNotaCreProveedor.updateRecordButton}" id="updateRecordButton" rendered="false" style="font-size: 14px" text="Guardar"/>
                                    </h:panelGrid>
                                    <h:panelGrid id="gridPanel2" style="width: 100%; height: 100%;">
                                        ...
                                        <webuijsf:table augmentTitle="false" id="table2" width="719">
                                            <webuijsf:tableRowGroup id="tableRowGroup2" rows="10" sourceData="#{ABMNotaCreProveedor.defaultTableDataProvider}" sourceVar="currentRow">
                                                <webuijsf:tableColumn headerText="Cod. Producto" id="tableColumn1" width="89">
                                                    <webuijsf:staticText id="staticText1" text="123"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn headerText="Producto" id="tableColumn6" width="116">
                                                    <webuijsf:staticText id="staticText5" text="Agenda"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn headerText="U. Medida" id="tableColumn7" width="73">
                                                    <webuijsf:staticText id="staticText6" text="Unidad"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn align="right" headerText="Cantidad" id="tableColumn8">
                                                    <webuijsf:staticText id="staticText7" text="2000"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn align="right" headerText="Precio Unitario" id="tableColumn9">
                                                    <webuijsf:staticText id="staticText9" text="7.000"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn align="right" headerText="IVA" id="tableColumn10">
                                                    <webuijsf:staticText id="staticText10" text="10%"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn align="right" headerText="Monto IVA" id="tableColumn12">
                                                    <webuijsf:staticText id="staticText11" text="1.400.000"/>
                                                </webuijsf:tableColumn>
                                                <webuijsf:tableColumn align="right" headerText="Monto Total" id="tableColumn13">
                                                    <webuijsf:staticText id="staticText12" text="14.000.000"/>
                                                </webuijsf:tableColumn>
