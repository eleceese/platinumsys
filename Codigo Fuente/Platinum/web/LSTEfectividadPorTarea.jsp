                    ...
                    <webuijsf:form id="form1">
                        ...
                        <div style="left: 288px; top: 216px; position: absolute">
                            <h:panelGrid columns="2" id="gridPanel1" style="height: 191px" width="407">
                                ...
                                <webuijsf:dropDown binding="#{LSTEfectividadPorTarea.uiEmpleado}" id="uiEmpleado" items="#{LSTEfectividadPorTarea.listaEmpleadosOp}"/>
                                ...
                                <h:panelGrid id="gridPanel2" style="height: 100%" width="191">
                                    ...
                                    <webuijsf:calendar binding="#{LSTEfectividadPorTarea.uiFechaDesde}" id="uiFechaDesde"/>
                                </h:panelGrid>
                                <h:panelGrid id="gridPanel3" style="height: 100%" width="159">
                                    <webuijsf:label id="label4" text="Hasta"/>
                                    <webuijsf:calendar binding="#{LSTEfectividadPorTarea.uiFechaHasta}" id="uiFechaHasta"/>
                                </h:panelGrid>
                                <h:panelGrid columns="2" id="gridPanel5" style="height: 35px" width="191">
                                    <webuijsf:button actionExpression="#{LSTEfectividadPorTarea.uiButtonEjecutar_action}" id="uiButtonEjecutar" text="Ejecutar"/>
