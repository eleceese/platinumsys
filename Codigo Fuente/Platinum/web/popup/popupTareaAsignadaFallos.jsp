                        ...
                        <webuijsf:table augmentTitle="false" id="table1" paginateButton="true" paginationControls="true"
                            ...
                            <webuijsf:tableRowGroup id="tableRowGroup1" rows="15" sourceData="#{SessionBean1.tareasAsignadasArray}" sourceVar="currentRow">
                                <webuijsf:tableColumn headerText="Tarea" id="tableColumn1" sort="codTarea">
                                    <webuijsf:hyperlink actionExpression="#{popup$popupTareaAsignadaFallos.hyperlink1_action}" id="hyperlink1"
                                        onClick="doSave('#{currentRow.value['codTareaAsignada']}', '#{currentRow.value['codTarea']}','#{currentRow.value['codTareaAsignada']}')" text="#{currentRow.value['codTarea']}"/>
                            ...
                            <f:facet name="actionsTop">
                                <webuijsf:panelGroup binding="#{popup$popupTareaAsignadaFallos.groupPanel1}" id="groupPanel1" separator="&amp;nbsp;">
                                    <webuijsf:textField binding="#{popup$popupTareaAsignadaFallos.uiTxtParam}" columns="35" id="uiTxtParam" label="Producto" tabIndex="1"/>
                                    <webuijsf:button actionExpression="#{popup$popupTareaAsignadaFallos.uiBtnBuscar_action}"
                                        binding="#{popup$popupTareaAsignadaFallos.uiBtnBuscar}" id="uiBtnBuscar" text="Buscar"/>
                                    <webuijsf:button actionExpression="#{popup$popupTareaAsignadaFallos.uiBtnTodos_action}"
                                        binding="#{popup$popupTareaAsignadaFallos.uiBtnTodos}" id="uiBtnTodos" text="Todos"/>
                                </webuijsf:panelGroup>
                            </f:facet>
                        </webuijsf:table>
                    </webuijsf:form>
