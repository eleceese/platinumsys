                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        <webuijsf:table augmentTitle="false" id="table1" paginateButton="true" paginationControls="true"
                            ...
                            <f:facet name="actionsTop">
                                <webuijsf:panelGroup binding="#{popup$popupTareas.groupPanel1}" id="groupPanel1" separator="&amp;nbsp;">
                                    <webuijsf:textField binding="#{popup$popupTareas.uiTxtParam}" columns="35" id="uiTxtParam" label="Tarea" tabIndex="1"/>
                                    <webuijsf:button actionExpression="#{popup$popupTareas.uiBtnBuscar_action}" binding="#{popup$popupTareas.uiBtnBuscar}"
                                        id="uiBtnBuscar" text="Buscar"/>
                                    <webuijsf:button actionExpression="#{popup$popupTareas.uiBtnTodos_action}" binding="#{popup$popupTareas.uiBtnTodos}"
