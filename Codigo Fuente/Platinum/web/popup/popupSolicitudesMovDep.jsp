                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        <webuijsf:table augmentTitle="false" id="table1" paginateButton="true" paginationControls="true"
                            ...
                            <webuijsf:tableRowGroup id="tableRowGroup1" rows="20" sourceData="#{SessionBean1.listaSolicitud}" sourceVar="currentRow">
                                <webuijsf:tableColumn headerText="Solicitud" id="tableColumn1">
                                    <webuijsf:hyperlink id="hyperlink1"
                                        onClick="doSave('#{currentRow.value['codSolicitud']}','#{currentRow.value['codProducto'].descripcion} Cant:#{currentRow.value['cantidadAprobada']}')" text="#{currentRow.value['codSolicitud']}"/>
                                ...
                                <webuijsf:tableColumn binding="#{popup$popupSolicitudesMovDep.tableColumn4}" headerText="Producto" id="tableColumn4" width="203">
                            ...
                            <f:facet name="actionsTop">
                                <webuijsf:panelGroup binding="#{popup$popupSolicitudesMovDep.groupPanel1}" id="groupPanel1" separator="&amp;nbsp;">
                                    <webuijsf:textField binding="#{popup$popupSolicitudesMovDep.uiTxtParam}" columns="35" id="uiTxtParam" label="Producto" tabIndex="1"/>
                                    <webuijsf:button actionExpression="#{popup$popupSolicitudesMovDep.uiBtnBuscar_action}"
                                        binding="#{popup$popupSolicitudesMovDep.uiBtnBuscar}" id="uiBtnBuscar" text="Buscar"/>
                                    <webuijsf:button actionExpression="#{popup$popupSolicitudesMovDep.uiBtnTodos_action}"
                                        binding="#{popup$popupSolicitudesMovDep.uiBtnTodos}" id="uiBtnTodos" text="Todos"/>
                                </webuijsf:panelGroup>
                            </f:facet>
                        </webuijsf:table>
                    </webuijsf:form>
