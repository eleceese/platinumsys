            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        <webuijsf:table augmentTitle="false" binding="#{popup$popupFormulasSemiter_1.table1}" id="table1" paginateButton="true"
                            ...
                            <f:facet name="actionsTop">
                                <webuijsf:panelGroup binding="#{popup$popupFormulasSemiter_1.groupPanel1}" id="groupPanel1" separator="&amp;nbsp;">
                                    <webuijsf:textField binding="#{popup$popupFormulasSemiter_1.uiTxtParam}" columns="35" id="uiTxtParam" label="Producto" tabIndex="1"/>
                                    <webuijsf:button actionExpression="#{popup$popupFormulasSemiter_1.uiBtnBuscar_action}"
                                        binding="#{popup$popupFormulasSemiter_1.uiBtnBuscar}" id="uiBtnBuscar" text="Buscar"/>
                                    <webuijsf:button actionExpression="#{popup$popupFormulasSemiter_1.uiBtnTodos_action}"
                                        binding="#{popup$popupFormulasSemiter_1.uiBtnTodos}" id="uiBtnTodos" text="Todos"/>
                                </webuijsf:panelGroup>
                            </f:facet>
                        </webuijsf:table>
                    </webuijsf:form>
