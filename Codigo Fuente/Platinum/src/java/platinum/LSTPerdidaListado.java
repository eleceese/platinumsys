...
public class LSTPerdidaListado extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        uiRadioDetalleSumaDefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("D", "Detalle"), new com.sun.webui.jsf.model.Option("S", "Suma")});
    }
    ...
    private SingleSelectOptionsList uiRadioDetalleSumaDefaultOptions = new SingleSelectOptionsList();

    public SingleSelectOptionsList getUiRadioDetalleSumaDefaultOptions() {
        return uiRadioDetalleSumaDefaultOptions;
    }

    public void setUiRadioDetalleSumaDefaultOptions(SingleSelectOptionsList ssol) {
        this.uiRadioDetalleSumaDefaultOptions = ssol;
    }
    private RadioButtonGroup uiRadioDetalleSuma = new RadioButtonGroup();

    public RadioButtonGroup getUiRadioDetalleSuma() {
        return uiRadioDetalleSuma;
    }

    public void setUiRadioDetalleSuma(RadioButtonGroup rbg) {
        this.uiRadioDetalleSuma = rbg;
    }
        ...
        String[] sparamName= new String[5];
                ...
                if (!uiProducto.getSelected().toString().equals("-1")){
                 ...
                 if (uiFechaIni.getSelectedDate() != null){
                    ...
                    sFecha = " and per.fecha_perdida >= to_date('"+simpleFecha+"','dd/mm/yyyy')";
                    sF = simpleFecha;
                }else{
                    sF="Todos";
                }
                ...
                if (uiFechaFin.getSelectedDate() != null){
                    ...
                    sFechaF = "and per.fecha_perdida <= to_date('"+simpleFechaF+"','dd/mm/yyyy')";
                    sFF = simpleFechaF;
                }else{
                    sFF="Todos";
                }
...
//                sFecHasta = " and TARJETAS.FECHA_ALTA <= convert(datetime,'"+f.getDateFormat((Date)calFecHasta.getValue())+"') ";
                ...
                sparamValue[4] = theApplicationsServletContext.getRealPath("/WEB-INF/classes/reportesFuente/logo_platinum.jpg");
                    ...
                    if (this.uiRadioDetalleSuma.getSelected().toString().equals("D")) {
                                        rpt.getReport(conn, "ListadoPerdidasProductos.jrxml", sparamName, sparamValue, theApplicationsServletContext);
                    }else{

                                        rpt.getReport(conn, "ListadoPerdidasProductosSuma.jrxml", sparamName, sparamValue, theApplicationsServletContext);
                    }
