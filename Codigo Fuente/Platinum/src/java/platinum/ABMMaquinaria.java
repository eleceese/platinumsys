 ...
 * @author FerBoy
 */
public class ABMMaquinaria extends AbstractPageBean {
    ...
    private TextField uiKWH = new TextField();

    public TextField getUiKWH() {
        return uiKWH;
    }

    public void setUiKWH(TextField tf) {
        this.uiKWH = tf;
    }
    private TextField uiCostMan = new TextField();

    public TextField getUiCostMan() {
        return uiCostMan;
    }

    public void setUiCostMan(TextField tf) {
        this.uiCostMan = tf;
    }
    private TextField uiHsMant = new TextField();

    public TextField getUiHsMant() {
        return uiHsMant;
    }

    public void setUiHsMant(TextField tf) {
        this.uiHsMant = tf;
    }
    ...
    getSessionBean1().setTituloPagina("Registro de Maquinarias");
    ...
    public void prerender() {
        ...
        if (addRequest) {
            ...
            this.datosBanco.setRendered(true);
            getSessionBean1().setTituloPagina("Registro de Maquinarias");
            getSessionBean1().setDetallePagina("Actualizacion de registro");
    ...
    private void cargarCampos() {
        ...
        Maquinarias e = new MaquinariaController().findById(getSessionBean1().getId());

        uiTxtDescripcion.setText(e.getDescripcion().toString());
        uiKWH.setText(e.getConsumoKwh().toString());
        uiCostMan.setText(e.getCostoMantenimiento().toString());
        uiHsMant.setText(e.getHorasMantenimento().toString());
    }
    ...
    public String editar_action() {
        ...
        if (getTableRowGroup1().getSelectedRowsCount() > 0) {
            ...
            Maquinarias[] l = getSessionBean1().getListaMaquinarias();

            //Posicion en la grilla del elemento seleccionado
            int rowId = Integer.parseInt(selectedRowKeys[0].getRowId());

            //Elemento seleccionado
            Maquinarias e = l[rowId];

            //Guardamos el id del Banco en la session
            getSessionBean1().setId(e.getCodMaquinaria());
        }
    ...
    public String uiBtnGuardarNuevo_action() {
        ...
        if (!errorValidacion) {
            ...
            r.setDescripcion((String) uiTxtDescripcion.getText());
            r.setCostoMantenimiento(Long.valueOf(uiCostMan.getText().toString()));
            r.setHorasMantenimento(Long.valueOf(uiHsMant.getText().toString()));
            r.setConsumoKwh(Long.valueOf(uiKWH.getText().toString()));

            //Insertamos el nuevo registro
            ControllerResult cr = new MaquinariaController().create(r);
    ...
    private void validarCampos() {
        ...
        if (this.uiKWH.getText() == null
                || this.uiKWH.getText().toString().equals("")
                || !StringUtils.esNumero(this.uiKWH.getText().toString())){
                info(uiKWH, "Favor ingrese correctamente el valor de consumo de energia");
                errorValidacion = true;
        }
        if (this.uiCostMan.getText() == null
                || this.uiCostMan.getText().toString().equals("")
                || !StringUtils.esNumero(this.uiCostMan.getText().toString())){
                info(uiCostMan, "Favor ingrese correctamente el valor de costo de Mantenimiento");
                errorValidacion = true;
        }
        if (this.uiHsMant.getText() == null
                || this.uiHsMant.getText().toString().equals("")
                || !StringUtils.esNumero(this.uiHsMant.getText().toString())){
                info(uiHsMant, "Favor ingrese correctamente el valor de Horas de Mantenimiento");
                errorValidacion = true;
        }
    ...
    public void buscar() {
        ...
        MaquinariaController c = new MaquinariaController();
        ...
        Maquinarias[] l = (Maquinarias[]) c.getMaquinariass(pCod, pDesc).toArray(new Maquinarias[0]);

        //Actualizamos la lista de empleados de la session
        getSessionBean1().setListaMaquinarias(l);
    }
    ...
    public String uiBtnGuardarEditar_action() {
        ...
        //Obtenemos el registro seleccionado por medio
        //del id almacenado en la session
        Maquinarias r = new MaquinariaController().findById(getSessionBean1().getId());
        ...
        if (!errorValidacion) {
            ...
            //Insertamos el nuevo registro
            ControllerResult cr = new MaquinariaController().update(r);
