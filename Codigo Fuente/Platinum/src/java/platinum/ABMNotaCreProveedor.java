 ...
 * @author MartinJara
 */
public class ABMNotaCreProveedor extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        dropDown2DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("PE", "Pendiente"), new com.sun.webui.jsf.model.Option("AP", "Aplicado"), new com.sun.webui.jsf.model.Option("AN", "Anulado")});
        dropDown2DefaultOptions.setSelectedValue("AP");
    }
    ...
    public void prerender() {
        ...
        if (addRequest) {
            ...
            getSessionBean1().setTituloPagina("Notas de Crédito Proveedor");
            getSessionBean1().setDetallePagina("Registro de Notas de Crédito Proveedor");
    ...
    public String addButton_action() {
        addRequest = true;
        getSessionBean1().setTituloPagina("Nueva Nota de Crédito Proveedor");
        getSessionBean1().setDetallePagina("Registro de Notas de Crédito - Proveedor");
        return null;
    }
    ...
    public String updateButton_action() {
        updateRequest = true;
        getSessionBean1().setTituloPagina("Editar Nota de Crédito Proveedor");
        getSessionBean1().setDetallePagina("Edición de Notas de Crédito - Proveedor");
        return null;
    }
