 ...
 * @author MartinJara
 */
public class ABMNotaCreCliente extends AbstractPageBean {
    ...
    public void prerender() {
        ...
        if (addRequest) {
            ...
            getSessionBean1().setTituloPagina("Notas de Crédito Cliente");
            getSessionBean1().setDetallePagina("Registro de Notas de Crédito Cliente");
    ...
    public String addButton_action() {
        addRequest = true;
        getSessionBean1().setTituloPagina("Nueva Nota de Crédito Cliente");
        getSessionBean1().setDetallePagina("Registro de Notas de Crédito - Cliente");
        return null;
    }
    ...
    public String updateButton_action() {
        updateRequest = true;
        getSessionBean1().setTituloPagina("Editar Nota de Crédito Cliente");
        getSessionBean1().setDetallePagina("Edición de Notas de Crédito - Cliente");
        return null;
    }
