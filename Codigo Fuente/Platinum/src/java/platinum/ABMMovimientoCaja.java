 ...
 * @author MartinJara
 */
public class ABMMovimientoCaja extends AbstractPageBean {
    ...
    public void prerender() {
        ...
        if (addRequest) {
            ...
            getSessionBean1().setTituloPagina("Movimiento de Caja");
            getSessionBean1().setDetallePagina("Registro de Movimiento de Caja - Cobranza");
    ...
    public String addButton_action() {
        addRequest = true;
        getSessionBean1().setTituloPagina("Nuevo Movimiento de Caja");
        getSessionBean1().setDetallePagina("Registro Movimiento de Caja - Cobranza");
        return null;
    }

    public String updateButton_action() {
        updateRequest = true;
        getSessionBean1().setTituloPagina("Editar Movimiento de Caja");
        getSessionBean1().setDetallePagina("Edición Movimiento de Caja - Cobranza");
        return null;
    }
