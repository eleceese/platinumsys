...
public class ABMSecciones extends AbstractPageBean {
    ...
    private TextField seccion2 = new TextField();

    public TextField getSeccion2() {
        return seccion2;
    }

    public void setSeccion2(TextField tf) {
        this.seccion2 = tf;
    }
    ...
    public String button2_action() {
        ...
        info(this.seccion2, "Favor ingresar Apellido, Campo Obligatorio");
