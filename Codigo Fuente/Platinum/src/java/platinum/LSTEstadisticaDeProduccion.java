...
public class LSTEstadisticaDeProduccion extends AbstractPageBean {
     ...
     */
    public LSTEstadisticaDeProduccion() {
    }
    ...
    public void prerender() {
        getSessionBean1().setTituloPagina("Listado de Estadísticas de Producción");
        getSessionBean1().setDetallePagina("Generar listado de estadístico de producción por,	 fecha inicial, fecha final, producto genérico, tipo producto, producto y empleado");
    }
