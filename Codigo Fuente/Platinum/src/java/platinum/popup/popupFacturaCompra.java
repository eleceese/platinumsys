 ...
 * @author Martin Jara
 */
public class popupFacturaCompra extends AbstractPageBean {
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        FacturaCompraCab[] l = (FacturaCompraCab[]) new FacturaCompraCabController().getFacturaCompraCab(param, FacturaCompraEstado.RECIBIDO).toArray(new FacturaCompraCab[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaFacturaCompra(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        FacturaCompraCab[] l = (FacturaCompraCab[]) new FacturaCompraCabController().getFacturaCompraCab(null, FacturaCompraEstado.RECIBIDO).toArray(new FacturaCompraCab[0]);
