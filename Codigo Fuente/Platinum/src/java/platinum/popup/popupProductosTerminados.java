 ...
 * @author Martin Jara
 */
public class popupProductosTerminados extends AbstractPageBean {
     ...
     */
    public popupProductosTerminados() {
    }
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        Producto[] l = (Producto[]) new ProductoController().getAllFiltered(null, param, "Terminado", null).toArray(new Producto[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaProductosTerminados(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        Producto[] l = (Producto[]) new ProductoController().getAllFiltered(null, null, "Terminado", null).toArray(new Producto[0]);
