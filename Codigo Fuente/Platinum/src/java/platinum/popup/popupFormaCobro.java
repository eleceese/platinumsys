 ...
 * @author Martin Jara
 */
public class popupFormaCobro extends AbstractPageBean {
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        FormaPago[] l = (FormaPago[]) new FormaPagoController().getFormaPagos(null, param).toArray(new FormaPago[0]);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        FormaPago[] l = (FormaPago[]) new FormaPagoController().getFormaPagos(null, null).toArray(new FormaPago[0]);
