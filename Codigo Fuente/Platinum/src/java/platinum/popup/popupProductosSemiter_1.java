 ...
 * @author Martin Jara
 */
public class popupProductosSemiter_1 extends AbstractPageBean {
     ...
     */
    public popupProductosSemiter_1() {
    }
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        Producto[] l = (Producto[]) new ProductoController().getSemiAcabado(null, param, null).toArray(new Producto[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaProductosSemiterminadosAcabados(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        Producto[] l = (Producto[]) new ProductoController().getSemiAcabado(null, null, null).toArray(new Producto[0]);
