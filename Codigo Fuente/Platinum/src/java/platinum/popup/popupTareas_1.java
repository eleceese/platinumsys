 ...
 * @author Martin Jara
 */
public class popupTareas_1 extends AbstractPageBean {
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        Tarea [] l = (Tarea[]) new TareaController().getAllFiltered(null, param).toArray(new Tarea[0]);

        //Actualizamos la lista de la session
        getSessionBean1().setListaTareas(l);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        Tarea[] l = (Tarea[]) new TareaController().getAllFiltered(null, null).toArray(new Tarea[0]);
