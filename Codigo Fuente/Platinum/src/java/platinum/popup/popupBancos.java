 ...
 * @author Martin Jara
 */
public class popupBancos extends AbstractPageBean {
    ...
    public String uiBtnBuscar_action() {
        ...
        //Obetenmos la lista
        Banco[] l = (Banco[]) new BancoController().getBancos(null, param).toArray(new Banco[0]);
    ...
    public String uiBtnTodos_action() {
        //Obetenmos la lista
        Banco[] l = (Banco[]) new BancoController().getBancos(null, null).toArray(new Banco[0]);
