...
public class LSTEstadisticasCostosProduccion extends AbstractPageBean {
     ...
     */
    public LSTEstadisticasCostosProduccion() {
    }
    ...
    public void prerender() {
        getSessionBean1().setTituloPagina("Listado de Estadísticas de Costos de Producción");
        getSessionBean1().setDetallePagina("Generar listado de estadístico de costos de producción por, fecha inicial, fecha final, producto genérico, tipo producto, producto y numero Orden de trabajo");
    }
