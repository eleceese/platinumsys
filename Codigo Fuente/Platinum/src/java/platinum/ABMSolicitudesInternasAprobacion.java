 ...
 * @author MartinJara
 */
public class ABMSolicitudesInternasAprobacion extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        dropDown1DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("A", "ACTIVO"), new com.sun.webui.jsf.model.Option("I", "INACTIVO")});
        dropDown1DefaultOptions.setSelectedValue("A");
        radioButtonGroup1DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("P", "Pendiente"), new com.sun.webui.jsf.model.Option("A", "Aprobado"), new com.sun.webui.jsf.model.Option("R", "Rechazado")});
        radioButtonGroup1DefaultOptions.setSelectedValue("P");
        //table1.setWidth();
    }
     ...
     */
    public ABMSolicitudesInternasAprobacion() {
    }
    ...
    public void prerender() {
        ...
        if (addRequest) {
            ...
            getSessionBean1().setTituloPagina("Aprobación de Solicitudes Internas");
            getSessionBean1().setDetallePagina("");
    ...
    public String updateButton_action() {
        updateRequest = true;
        pageAlert1.setRendered(false);
        getSessionBean1().setTituloPagina("Aprobarción Solicitud Interna");
        return null;
    }
    ...
    public String addRecordButton_action() {
        ...
        if (!errorValidacion) {
            ...
            this.pageAlert1.setTitle("Solicitud Aprobada");
