...
public class LSTExtractoCtaCliente extends AbstractPageBean {
    ...
    public void prerender() {
        getSessionBean1().setTituloPagina("Extracto de cuenta cliente");
        getSessionBean1().setDetallePagina("Generar resumen de estado de cuenta por cliente y en un rango de fecha desde – Hasta");
    }
