...
public class ABMEmpleados extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        dropDown2DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("J", "Jefe"), new com.sun.webui.jsf.model.Option("P", "Productor"), new com.sun.webui.jsf.model.Option("S", "Supervisor"), new com.sun.webui.jsf.model.Option("R", "Recepcion"), new com.sun.webui.jsf.model.Option("V", "Vendedor")});
        dropDown3DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("A", "Administracion"), new com.sun.webui.jsf.model.Option("C", "Comercial"), new com.sun.webui.jsf.model.Option("P", "Produccion")});
    }
