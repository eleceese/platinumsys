...
public class VentaComisionMensualController extends AbstractJpaDao<VentaComisionMensual> {
     ...
     */
    public List<VentaComisionMensual> getVentaComisionMensual(String codigo, String descripcion) {
        //Armamos el sql String
        String SQL = "SELECT o FROM VentaComisionMensual o WHERE o.codVentaComisionMensual = o.codVentaComisionMensual";

        if (codigo != null && !codigo.equals("")) {
            SQL = SQL + " and UPPER(o.codVentaComisionMensual) like UPPER(:codigo)";
        }

        if (descripcion != null && !descripcion.equals("")) {
            SQL = SQL + " and UPPER(o.nombreVentaComisionMensual) like UPPER(:descripcion)";
        }
